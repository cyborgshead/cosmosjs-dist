...
var LedgerWalletProvider = /** @class */ (function () {
    function LedgerWalletProvider(transport, bech32PrefixAccAddr, account, index) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 10:
                        ...
                        this.key = {
                            address: address_1.AccAddress.fromBech32(this.bech32PrefixAccAddr, response.bech32_address).toBytes(),
    ...
    LedgerWalletProvider.prototype.getKeys = function (context) {
        ...
        var bech32Address = new address_1.AccAddress(this.key.address, this.bech32PrefixAccAddr).toBech32();
        var key = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (new address_1.AccAddress(this.key.address, this.bech32PrefixAccAddr).toBech32() !==
                            bech32Address) {
